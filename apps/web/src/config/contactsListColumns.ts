...
export const BUILT_IN_CONTACTS_COLUMNS: ListColumnDefinition[] = [
  { key: 'name', hebrewHeader: 'שם', source: 'built_in', defaultVisible: true, defaultOrder: 0, required: true },
  { key: 'roles', hebrewHeader: 'תפקידים', source: 'built_in', defaultVisible: true, defaultOrder: 1 },
  /**
   ...
   */
  { key: 'birthDateGregorian', hebrewHeader: 'תאריך לידה לועזי', source: 'built_in', defaultVisible: true, defaultOrder: 2 },
  { key: 'birthDateHebrew', hebrewHeader: 'תאריך לידה עברי', source: 'built_in', defaultVisible: false, defaultOrder: 3 },
  { key: 'phone', hebrewHeader: 'טלפון', source: 'built_in', defaultVisible: true, defaultOrder: 4 },
  { key: 'email', hebrewHeader: 'דוא"ל', source: 'built_in', defaultVisible: true, defaultOrder: 5 },
  { key: 'address', hebrewHeader: 'כתובת', source: 'built_in', defaultVisible: false, defaultOrder: 6 },
  { key: 'tags', hebrewHeader: 'תגיות', source: 'built_in', defaultVisible: true, defaultOrder: 7 },
  { key: 'status', hebrewHeader: 'סטטוס', source: 'built_in', defaultVisible: true, defaultOrder: 8 },
];
