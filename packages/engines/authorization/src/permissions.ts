...
export const permissionRegistry: PermissionDefinition[] = [
  ...
  { id: 'entities.edit', label: 'עריכת פרטי ישות', description: 'עריכת שם, פרטי זיהוי ופרטי התקשרות של אדם או ארגון.' },
  { id: 'entities.roles.manage', label: 'ניהול תפקידים', description: 'הוספה או הסרה של תפקידים המשויכים לישות.' },
  { id: 'entities.view_sensitive', label: 'צפייה במידע רגיש', description: 'צפייה במידע זיהוי רגיש כגון מספר זהות מלא.' },
  ...
  { id: 'entities.merge', label: 'מיזוג ישויות כפולות', description: 'התחלת תהליך השוואה ומיזוג של ישויות חשודות ככפולות.' },
  {
  ...
  { id: 'entities.archive', label: 'העברה לארכיון / שחזור ישות', description: 'העברת ישות לארכיון או שחזורה ממנו.' },
  { id: 'finance.view', label: 'צפייה במידע כספי', description: 'צפייה במידע כספי המשויך לישות.' },
  { id: 'finance.payment_priority', label: 'שימוש בסימוני עדיפות תשלום', description: 'סימון עדיפות עבור תשלומים עתידיים.' },
  {
  ...
  { id: 'modules.access', label: 'גישה למודולים ייעודיים', description: 'גישה למודולים או פעולות ספציפיות במערכת.' },
  {
  ...
  { id: 'custom_fields.manage', label: 'ניהול שדות מותאמים אישית', description: 'יצירה, עריכה והשבתה של הגדרות שדות מותאמים אישית.' },
  {
  ...
  },
  {
    ...
    description: 'קביעה האם שדה (כגון תאריך לידה) מוסתר, אופציונלי או חובה, לפי סוג ישות, תפקיד או מוסד.',
  },
  { id: 'contact_methods.edit', label: 'עריכת אמצעי התקשרות', description: 'עריכת טלפון, דוא"ל או כתובת קיימים.' },
  {
  ...
  { id: 'birth_date.view', label: 'צפייה בתאריך לידה', description: 'צפייה בתאריך הלידה הלועזי והעברי של איש קשר.' },
  { id: 'birth_date.edit', label: 'עריכת תאריך לידה', description: 'עריכת תאריך הלידה הלועזי ותיקון התאריך העברי.' },
];
